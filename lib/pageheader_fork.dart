...
class _LargeTitleNavigationBarSliverDelegate extends SliverPersistentHeaderDelegate
  ...
  Widget build(BuildContext context, double shrinkOffset, bool overlapsContent) {
    ...
    // Count how much the title is scrolled in percent

    // Calculate how much the bottom should shrink.
    final double bottomShrinkFactor = clampDouble(shrinkOffset / bottomHeight, 0, 1);

    print('minExtent: $minExtent, maxExtent: $maxExtent, shrinkOffset: $shrinkOffset');
    print('calc ');

    final titleThresold = maxExtent - minExtent - bottomHeight;
    // calculate visible part of large title
    final double visibleLargeTitleHeight = (shrinkOffset - bottomHeight) / titleThresold;
